...
public class UniversityEnrollmentSystem {
    ...
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Francis", 20, "S001", "Computer Engineering", 15);
        Student student2 = new Student("Jay", 22, "S002", "Computer Science", 12);

        // Creating two Instructor objects
        Instructor instructor1 = new Instructor("Dr. Salvador", 45, "E001", "Applied Mathematics", 60000); //
        Instructor instructor2 = new Instructor("Prof. Tanya Carmela", 22, "E002", "CEA", 70000);
